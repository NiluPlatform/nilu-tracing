...
contract TraceableCreatorV1 is TraceableCreator {
    ...
    function create(uint256 tokenId, address genesis ,string calldata _label
    ,string calldata _traceableType
    ,uint256 _quantity, bool _partiallyTransferEnabled) external returns (Traceable) {
       return new TraceableV1(tokenId, genesis, _label, _traceableType, _quantity, _partiallyTransferEnabled);
    }
